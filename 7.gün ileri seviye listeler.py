...
liste1=[1,2,3,4]
liste1.extend([1,2,5,8,7])
print(liste1) #[1, 2, 3, 4, 1, 2, 5, 8, 7]

#insert() metodu
#insert() metodu listenin belli bir indeksine bir eleman eklememizi sağlar.
liste = [1,2,3,4,5,6,7,8,9]
liste.insert(2,"python") #2.indeksine python eklendi
print(liste) #[1, 2, 'python', 3, 4, 5, 6, 7, 8, 9]
...
liste.remove("Java")
print(liste) #['Python', 'Php', 'C']  # Listede yok isehata verir.
